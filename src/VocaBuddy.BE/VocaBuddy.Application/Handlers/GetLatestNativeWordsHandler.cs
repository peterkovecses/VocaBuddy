...
public class GetLatestNativeWordsHandler : IRequestHandler<GetLatestNativeWordsQuery, Result<List<NativeWordDto>>>
{
    ...
    public async Task<Result<List<NativeWordDto>>> Handle(GetLatestNativeWordsQuery request, CancellationToken cancellationToken)
    {
