...
public class RegistrationRequestValidator : AbstractValidator<UserRegistrationRequest>
{
    public RegistrationRequestValidator(IOptions<IdentityOptions> options)
    {
