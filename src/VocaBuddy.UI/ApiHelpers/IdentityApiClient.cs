...
public class IdentityApiClient(HttpClient client, IOptions<IdentityApiConfiguration> identityOptions) : IIdentityApiClient
{
    ...
    {
        var response = await client.PostAsJsonAsync(_identityConfig.LoginEndpoint, loginRequest);
    ...
    {
        var response = await client.PostAsJsonAsync(_identityConfig.RegisterEndpoint, registrationRequest);
    ...
    {
        var response = await client.PostAsJsonAsync(_identityConfig.RefreshEndpoint, refreshTokenRequest);
